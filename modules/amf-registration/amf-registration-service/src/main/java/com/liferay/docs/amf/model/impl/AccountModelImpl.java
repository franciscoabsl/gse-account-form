...
public class AccountModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"emailAddress", Types.VARCHAR}, {"_userName", Types.VARCHAR},
		{"gender", Types.VARCHAR}, {"birthday", Types.TIMESTAMP},
		{"password1", Types.VARCHAR}, {"confirmPassword", Types.VARCHAR},
		...
		{"securityAnswer", Types.VARCHAR}, {"termsOfUse", Types.BOOLEAN}
	};
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("_userName", Types.VARCHAR);
	 ...
	 */
	@Deprecated
	public static final long _USERNAME_COLUMN_BITMASK = 1L;
	...
	static {
		...
		attributeGetterFunctions.put("_userName", Account::get_userName);
		attributeSetterBiConsumers.put(
			"_userName", (BiConsumer<Account, String>)Account::set_userName);
	...
	public String getOriginal_userName() {
		return getColumnOriginalValue("_userName");
	}
	...
	public Object clone() {
		...
		accountImpl.set_userName(get_userName());
	...
	public Account cloneWithOriginalValues() {
		...
		accountImpl.set_userName(
			this.<String>getColumnOriginalValue("_userName"));
	...
	public CacheModel<Account> toCacheModel() {
		...
		accountCacheModel._userName = get_userName();

		String _userName = accountCacheModel._userName;

		if ((_userName != null) && (_userName.length() == 0)) {
			accountCacheModel._userName = null;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("_userName", __userName);
	...
	static {
		...
		columnBitmasks.put("_userName", 2048L);
		...
		columnBitmasks.put("confirmPassword", 32768L);

		columnBitmasks.put("homePhone", 65536L);

		columnBitmasks.put("mobilePhone", 131072L);

		columnBitmasks.put("address1", 262144L);
